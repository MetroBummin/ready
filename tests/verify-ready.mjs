...
assert.match(edge,/item\.kind === "correction_pairs" \|\| \[2, 3, 9\]\.includes\(Number\(item\.stage\)\) \? \{ mode: "server_deterministic" \}/,'Recall, correction, and writing stages must not carry plaintext answers in the public Workbook payload');
