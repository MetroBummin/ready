...
import { normalizeWorkbookAnswer as normalizeWorkbookAnswerClient, livePrefixState, workbookRecallCue as workbookRecallCueClient, workbookRecallIsPendingJamo, workbookSlotCh } from '../ready/workbook-assistance.js';
