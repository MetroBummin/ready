...
assert.match(css,/reader-inline-save-toggle\{[^}]*width:1\.2em[^}]*font:760 \.62em\/1/,'Save and remove marks must share a fixed visual box');
assert.match(css,/reader-inline-save-toggle::before\{[^}]*inset:-12px/,'Small save marks must retain a large touch target');
