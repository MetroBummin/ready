...
for(const [index,question] of written.entries()){
  ...
  try{
    const structured=applyAnswerKeyWordCounts(payload,callCodex(question,canonical)),issues=validateWrittenStructure(question,structured,canonical);
